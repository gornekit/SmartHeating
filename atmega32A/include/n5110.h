...
#define SPI_MOSI_PIN               PB5  // SDIN 
#define LCD_RST_PIN                PB6	// RESET
#define SPI_CLK_PIN                PB7  // SCLK 
...
byte Lcd_rect_empty       ( byte x1, byte y1, byte x2, byte y2, LcdPixelMode mode );   // Прямоугольник
